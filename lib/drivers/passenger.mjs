...
export async function installDeps(ctx, app, { onProgress, timeout = 900_000 } = {}) {
  /*
   * ⚠ `app_path` EV DİZİNİNE GÖRELİ olmalı — mutlak yol reddediliyor.
   *
   * cPanel'in kendi dokümanı bunun tersini söylüyor ve örnek olarak
   * `/home/example/my-app/` veriyor; canlı sunucuda o biçim "Invalid path"
   * dönüyor, `patest` biçimi çalışıyor. Dokümanı değil sunucuyu izliyoruz.
   */
