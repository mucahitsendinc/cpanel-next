 ...
 *
 * Algoritma `lib/htaccess.mjs`'e taşındı: aynı işi Laravel yönlendirme bloğu
 * da yapıyor ve iki kopya tutmak, birinde düzeltilen bir davranışın diğerinde
 * kalması demekti. Bu sarmalayıcı, mevcut çağrı imzasını koruyor.
 */
export function mergeBlock(current, block = BLOCK) {
  return mergeMarked(current, { begin: BEGIN, end: END, block });
}
