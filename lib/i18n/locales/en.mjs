...
`,
  ...
  laravel: {
    ...
    noNodeModules: 'There are assets to build with {builder}, but there is no local node_modules.',
    noNodeModulesHint: 'Run "{pm} install" first, then "{pm} run build". Assets are never built on the server (LVE memory limit).',
